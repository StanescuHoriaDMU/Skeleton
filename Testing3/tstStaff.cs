...
namespace Testing3
{
    ...
    public class tstStaff
    {
        ...
        public void EmailAddressMax()
        {
            ...
            String Error = "";
            string EmailAddress = "";
            FullName = FullName.PadRight(320, 'a');
            Error = aStaff.Valid(StaffID, FullName, UserName, EmailAddress, DOB);
            Assert.AreEqual(Error, "");
        }
